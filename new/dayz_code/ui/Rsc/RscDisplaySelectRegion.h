class RscDisplaySpawnSelecter
{
	...
	onLoad = "dz_gui_region = true; dz_gui_gender_result = 0;";
	onUnload = "dz_gui_region = false;";
	...
	class controls
	{
		class Random : RscActiveText
		{
			...
			color[] = { 0.5, 0.5, 0.5, 1 };
			colorActive[] = { 1, 1, 1, 1 };
			action = "closeDialog 0; dz_gui_region = false; dz_gui_region_result = 0;";
			onMouseEnter = "ctrlSetFocus (_this select 0)";
		};
		
		class Kamenka : RscActiveText
		{
			idc = -1;
			style = 48;
			...
			color[] = { 0.5, 0.5, 0.5, 1 };
			colorActive[] = { 1, 1, 1, 1 };
			action = "closeDialog 0; dz_gui_region = false; dz_gui_region_result = 1;";
			onMouseEnter = "ctrlSetFocus (_this select 0)";
		};
		
		class Balota : RscActiveText
		{
			idc = -1;
			style = 48;
			...
			color[] = { 0.5, 0.5, 0.5, 1 };
			colorActive[] = { 1, 1, 1, 1 };
			action = "closeDialog 0; dz_gui_region = false; dz_gui_region_result = 2;";
			onMouseEnter = "ctrlSetFocus (_this select 0)";
		};
		
		class Chernogorsk : RscActiveText
		{
			idc = -1;
			style = 48;
			...
			color[] = { 0.5, 0.5, 0.5, 1 };
			colorActive[] = { 1, 1, 1, 1 };
			action = "closeDialog 0; dz_gui_region = false; dz_gui_region_result = 3;";
			onMouseEnter = "ctrlSetFocus (_this select 0)";
		};
		
		class Elektrozavodsk : RscActiveText
		{
			idc = -1;
			style = 48;
			...
			color[] = { 0.5, 0.5, 0.5, 1 };
			colorActive[] = { 1, 1, 1, 1 };
			action = "closeDialog 0; dz_gui_region = false; dz_gui_region_result = 4;";
			onMouseEnter = "ctrlSetFocus (_this select 0)";
		};
		
		class Solnichniy : RscActiveText
		{
			idc = -1;
			style = 48;
			...
			color[] = { 0.5, 0.5, 0.5, 1 };
			colorActive[] = { 1, 1, 1, 1 };
			action = "closeDialog 0; dz_gui_region = false; dz_gui_region_result = 5;";
			onMouseEnter = "ctrlSetFocus (_this select 0)";
		};
		
		class Berezino : RscActiveText
		{
			idc = -1;
			style = 48;
			...
			color[] = { 0.5, 0.5, 0.5, 1 };
			colorActive[] = { 1, 1, 1, 1 };
			action = "closeDialog 0; dz_gui_region = false; dz_gui_region_result = 6;";
			onMouseEnter = "ctrlSetFocus (_this select 0)";
		};
	};
};
