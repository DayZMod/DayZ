class RscDisplayGear
{
	...
	onLoad = "_this call dz_fn_ui_gear_load";
	onUnload = "_this call dz_fn_ui_gear_unload";
		...
		class ListboxArrows : RscControlsGroup
		{
			...
			class Controls
			{
				class CA_B_Add : RscGearShortcutButton
				{
					...
					x = -2;
					style = 2048;
					onButtonClick = "[_this, 'onLBListSelChanged'] call dz_fn_ui_gear_handleGear";
					text = "&lt;";
				};
				...
				class Available_items : RscIGUIListNBox
				{
					...
					shadow = 0;
					onLBSelChanged = "[_this, 'onLBSelChanged'] call dz_fn_ui_gear_handleGear";
					x = 0;
					y = 0;
					//w = 0.46;
					w = 0.507;
		...
		class G_GearItems : RscControlsGroup
		{
			...
			class Controls
			{
				class CA_Gear_slot_primary : RscActiveText
				{
					...
					h = 0.174;
					style = ST_PICTURE + ST_KEEP_ASPECT_RATIO;
					onMouseButtonDown = "_this call dz_fn_ui_contextMenu_mouseButtonDown;";
				...
				class CA_Gear_slot_secondary : CA_Gear_slot_primary
				{
					...
					onMouseButtonDbgClick = "_this call dz_fn_ui_gear_openBackpack";
				};
				...
				class ButtonOpenBag : RscActiveText
				{
					...
					action = "_this call dz_fn_ui_gear_openBackpack";
				};
				...
				class ButtonCloseBag : RscActiveText
				{
					...
					color[] = {1, 1, 1, 0.5};
					colorActive[] = {1, 1, 1, 0.8};
					action = "_this call dz_fn_ui_gear_closeBackpack";
				};
