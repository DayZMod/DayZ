...
*/
	...
	#define Player_AddItem_FAILURE 0
	#define Player_AddItem_PLAYER 1
	#define Player_AddItem_GROUND 2
	#define Player_AddItem_VEHICLE 3
	...
	#define Player_GetStanceAnim() (dz_player_stanceAnims select floor (((toArray toLower animationState player select 5) - 100) / 5))
	#define Player_GetWeaponAnim() (dz_player_weaponAnims select floor (((toArray toLower animationState player select 13) - 107) / 2))
#endif