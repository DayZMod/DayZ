...
CrashSiteType[] =
{
	{Loot_NONE,			2,		DZ_CrashSite_RU, CrashSiteRU},		//Russian Mi-8
	{Loot_NONE,			1,		DZ_CrashSite_US, CrashSiteUS},		//American UH-1Y
	{Loot_NONE,			1,		DZ_CrashSite_EU, CrashSiteEU},		//European HC3
	{Loot_NONE,			1,		DZ_CrashSite_UN, CrashSiteUN}		//United Nations Mi-8
};
