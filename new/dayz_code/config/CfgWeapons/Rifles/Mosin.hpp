...
class Mosin_Base : Rifle
{
	...
	begin1[] = {z\addons\dayz_communityweapons\models\mosin_nagant\sound\Mosin.ogg, db5, 1, 1500};
	soundBegin[] = {begin1, 1};
	drySound[] = {"Ca\sounds\Weapons\rifles\dry",0.01,1,10};
	reloadMagazineSound[] = {z\addons\dayz_communityweapons\models\mosin_nagant\sound\reload.ogg, db-40, 1, 20};
};
