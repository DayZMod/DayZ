...
class DZ_CrashSite_RU : DZ_CrashSite
{
	scope = public;
...
class DZ_CrashSite_UN : DZ_CrashSite_RU
{
	model = "\z\addons\dayz_communityassets\crashsite\mi8\mi8_un.p3d";
};

class DZ_CrashSite_US : DZ_CrashSite
{
	scope = public;
...
class DZ_CrashSite_EU : DZ_CrashSite
{
	scope = public;
