class jsrs_sfx_Treebird 
{
	sound[]  = {"\z\addons\dayz_communityassets\sounds\Environment\NoSound",0.12938,1};
	volume   = "0.093456*(trees)*(1-houses)*(1-hills)";
	sing1[]  = {"\z\addons\dayz_communityassets\sounds\Environment\SFX-Animals\TreeBird01",0.12938,1,45,0.100000,15,30,90};
	sing2[]  = {"\z\addons\dayz_communityassets\sounds\Environment\SFX-Animals\TreeBird02",0.12938,1,50,0.100000,15,30,90};
	sing3[]  = {"\z\addons\dayz_communityassets\sounds\Environment\SFX-Animals\TreeBird03",0.12938,1,55,0.080000,15,30,90};
