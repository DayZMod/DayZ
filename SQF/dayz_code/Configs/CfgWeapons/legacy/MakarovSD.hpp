class MakarovSD: Makarov {
	displayname = $STR_EQUIP_NAME_Makarov_SD;
	descriptionshort = $STR_EQUIP_DESC_Makarov_SD;
	access = 3;
	afmax = 0;
	aidispersioncoefx = 1;
	aidispersioncoefy = 1;
	...
	weaponlocksystem = 0;
	class Library {
		libtextdesc = "In use for nearly forty years the venerable PM Makarov served with the Soviet Red Army and now serves the Russian Federation Armed Forces. Equipped with a suppressor the silenced Makarov PM is an ideal weapon for special forces and assassins.";
	};
};