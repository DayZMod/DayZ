class Colt1911: M9 {
	displayname = $STR_EQUIP_NAME_M1911;
	descriptionshort = $STR_EQUIP_DESC_M1911;
	access = 3;
	afmax = 0;
	aidispersioncoefx = 1;
	aidispersioncoefy = 1;
	...
	begin2[] = {"ca\sounds\weapons\pistols\m9_single2", 0.794328, 1, 700};
	begin3[] = {"ca\sounds\weapons\pistols\m9_single3", 0.794328, 1, 700};
	...
	weaponlocksystem = 0;
	class Library {
		libtextdesc = "The 1911 (or M1911A1) is a single-action self-loading pistol. It was the standard side arm weapon used by the US army from 1911 to 1985; and was widely used by US troops in WW I, WW II and both Korean and Vietnam wars. <br/>The 1911 is designed to use .45 ACP rounds. Even today many SWAT teams - as well as many other armies Ã¢ÂÂ favor this weapon thanks to the great stopping power of .45 rounds.";
	};
};