class revolver_EP1: Pistol {
	displayname = $STR_EQUIP_NAME_Revolver;
	descriptionshort = $STR_EQUIP_DESC_Revolver;
	access = 3;
	afmax = 0;
	aidispersioncoefx = 1;
	aidispersioncoefy = 1;
	...
	begin1[] = {"Ca\Sounds_E\Weapons_E\revolver45\revolver45_1", 1, 1, 800};
	begin2[] = {"Ca\Sounds_E\Weapons_E\revolver45\revolver45_2", 1, 1, 800};
	...
	reloadaction = "";
	reloadmagazinesound[] = {"Ca\Sounds_E\Weapons_E\revolver45\reload", 1, 1, 20};
	reloadsound[] = {"", 1, 1};
	reloadtime = 0.5;
	scope = 2;
	...
	weaponlocksystem = 0;
	class Library {
		libtextdesc = "The Revolver .45 was adopted by the U.S. Army in 1917 to supplement the standard Colt 1911. It was primarily used by secondary and non-deployed troops.<br/>There were two variations of this weapon, one from Colt and one from SW.";
	};
};