class LeeEnfield_DZ : LeeEnfield
{
	...
	begin1[] = {"\z\addons\dayz_communityweapons\LeeEnfield\sounds\LeeEnfield_s1",5,1,1600};     // new sound
	begin2[] = {"\z\addons\dayz_communityweapons\LeeEnfield\sounds\LeeEnfield_s2",5,1,1600};     // new sound
	begin3[] = {"\z\addons\dayz_communityweapons\LeeEnfield\sounds\LeeEnfield_s3",5,1,1600};     // new sound
	begin4[] = {"\z\addons\dayz_communityweapons\LeeEnfield\sounds\LeeEnfield_s4",5,1,1600};     // new sound
