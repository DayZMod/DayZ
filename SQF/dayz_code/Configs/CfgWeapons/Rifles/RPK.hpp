...
class RPK_DZ : AK_47_M
{
	...
	{                                                                                     // new sound
		begin1[] = {"\z\addons\dayz_communityweapons\RPK\sounds\RPK_s1",5,1,1300};		  // new sound
		begin2[] = {"\z\addons\dayz_communityweapons\RPK\sounds\RPK_s2",5,1,1300};        // new sound
		begin3[] = {"\z\addons\dayz_communityweapons\RPK\sounds\RPK_s3",5,1,1300};        // new sound
		begin4[] = {"\z\addons\dayz_communityweapons\RPK\sounds\RPK_s4",5,1,1300};        // new sound
