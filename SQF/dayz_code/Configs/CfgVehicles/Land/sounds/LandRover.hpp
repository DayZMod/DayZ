soundEngineOnInt[] =  {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Int_Start",1,1};
soundEngineOnExt[] =  {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Ext_Start",1,1,100};
soundEngineOffInt[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Int_Off",1,1};
soundEngineOffExt[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Ext_Off",1,1,100};
class SoundEvents
{
	class AccelerationIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Int_Acc",1,1};
		limit = 0.15;
		expression = "engineOn*(1-camPos)*2*gmeterZ*((speed factor[0.5,5]) min (speed factor[5,0.5]))";
	};
	class AccelerationOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Ext_Acc",1,1,150};
		limit = 0.15;
...
class Sounds
{
	class Engine
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Ext_Low",1,1,560};
	...
	class EngineHighOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Ext_High",1,1,360};
		frequency = "(randomizer*0.02+0.98)*rpm";
		volume = "engineOn*camPos*(rpm factor[0.3, 1])";
	};
	class IdleOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Ext_Idle",1,1,150};
		frequency = "1";
	...
	class EngineLowIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Int_Low",1,1};
		frequency = "(randomizer*0.05+0.95)*rpm";
		volume = "((engineOn*thrust) factor[0.2,1])*(1-camPos)";		
	};
	class EngineHighIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Int_High",1,1};
		frequency = "0.25+(0.65*rpm)";
		volume = "2*engineOn*(1-camPos)*(rpm factor[0.3,1])";
	};
	class IdleIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\LandRover\Int_Idle",1,1};
		frequency = "1";
