soundEngineOnInt[] =  {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Int_Start",1,1};
soundEngineOnExt[] =  {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Ext_Start",1,1,100};
soundEngineOffInt[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Int_Off",1,1};
soundEngineOffExt[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Ext_Off",1,1,300};
class SoundEvents
{
	class AccelerationIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Int_Acc",1,1};
		limit = 0.15;
		expression = "engineOn*(1-camPos)*2*gmeterZ*((speed factor[0.5,5]) min (speed factor[5,0.5]))";
	};
	class AccelerationOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Ext_Acc",1,1,200};
		limit = 0.15;
...
class Sounds
{
	class Engine
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Ext_Low",1,1,550};
	...
	class EngineHighOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Ext_High",1,1,350};
		frequency = "(randomizer*0.02+0.98)*rpm";
		volume = "engineOn*camPos*(rpm factor[0.3, 1])";
	};
	class IdleOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Ext_Idle",1,1,200};
		frequency = "1";
	...
	class EngineIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Int_Low",1,1};
		frequency = "(randomizer*0.05+0.95)*rpm";
		volume = "((engineOn*thrust) factor[0.2,1])*(1-camPos)";		
	};
	class EngineHighIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Int_High",1,1};
		frequency = "0.25+(0.65*rpm)";
		volume = "2*engineOn*(1-camPos)*(rpm factor[0.3,1])";
	};
	class IdleIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\HMMWV\Int_Idle",1,1};
		frequency = "1";
