soundEngineOnInt[] =  {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\Int_Start",1,1};
soundEngineOnExt[] =  {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\Ext_Start",1,1,100};
soundEngineOffInt[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\Int_Off",1,1};
soundEngineOffExt[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\Ext_Off",1,1,100};
class SoundEvents
{
	class AccelerationIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\Int_Acc",1,1};
		limit = 0.15;
		expression = "engineOn*(1-camPos)*2*gmeterZ*((speed factor[0.5,5]) min (speed factor[5,0.5]))";
	};
	class AccelerationOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\Ext_Acc",1,1,100};
		limit = 0.15;
...
class Sounds
{
	class Engine
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\Ext_Low",1,1,500};
		frequency = "(randomizer*0.02+0.98)*rpm";
		volume = "engineOn*camPos*(rpm factor[0.3, 1])";
	};
	class EngineHighOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\Ext_High",1,1,300};
		frequency = "(randomizer*0.02+0.98)*rpm";
		volume = "engineOn*camPos*(rpm factor[0.3, 1])";
	...
	class IdleOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\Ext_Idle",1,1,200};
		frequency = "1";
	...
	class EngineLowIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\INT_Low", 1.000000, 1.000000};
		frequency = "(randomizer*0.05+0.95)*rpm";
		volume = "(1-camPos)*engineOn*(rpm factor[0.3, 1])";
	};
	class EngineHighIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\INT_high", 1.000000, 1.000000};
		frequency = "(randomizer*0.15+1.05)*rpm";	
		volume = "(1-camPos)*engineOn*(rpm factor[0.3,1.2])";
	};
	class IdleIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\V3S\INT_idle",1,1};
		frequency = "1";
