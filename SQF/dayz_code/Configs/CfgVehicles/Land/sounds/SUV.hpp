soundEngineOnInt[] =  {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Int_Start",1,1};
soundEngineOnExt[] =  {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Ext_Start",1,1,250};
soundEngineOffInt[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Int_Off",1,1};
soundEngineOffExt[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Ext_Off",1,1,100};
class SoundEvents
{
	class AccelerationIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Int_Acc",1,1};
		limit = 0.15;
		expression = "engineOn*(1-camPos)*2*gmeterZ*((speed factor[0.5,5]) min (speed factor[5,0.5]))";
	};
	class AccelerationOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Ext_Acc",1,1,200};
		limit = 0.15;
...
class Sounds
{
	class Engine
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Ext_Low",1,1,300};
	...
	class EngineHighOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Ext_High",1,1,450};
		frequency = 1;
		volume = "2*engineOn*camPos*(thrust factor[0.8,1])";
	};
	class IdleOut
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Ext_Idle",1,1,200};
		frequency = "1";
	...
	class EngineIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Int_Low",1,1};
		frequency = "(randomizer*0.05+0.95)*rpm";
		volume = "((engineOn*thrust) factor[0.65,0.2])*(1-camPos)";
	};
	class EngineHighIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Int_High",1,1};
		frequency = "0.25+(0.65*rpm)";
		volume = "2*engineOn*(1-camPos)*(rpm factor[0.3,1])";
	};
	class IdleIn
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\SUV\Int_Idle",1,1};
	...
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\Vehicle_noises\Tires\ExT_Asp SUV", 0.100000, 1.000000, 120};
	...
	class NoiseOut 
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\Vehicle_noises\Rattle\SUV_EXT_noises", 2, 1, 200};
		frequency = "1";
		volume = "camPos*(speed factor[2, 20])";
	};
	class NoiseIn 
	{
		sound[] = {"\z\addons\dayz_communityassets\sounds\Vehicles\Land\Vehicle_noises\Rattle\SUV_INT_noises", 2, 1};
		frequency = "1";
