...
if (true) then
{
  _this = "Land_Camp_Fire_DZ" createVehicleLocal [11817.798, 12693.678, -0.17121282];
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
...
if (true) then
{
  _this = "Land_Camp_Fire_DZ" createVehicleLocal [11862.348, 12748.077, -0.35221288];
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
...
if (true) then
{
  _this = "Land_Camp_Fire_DZ" createVehicleLocal [11863.922, 12749.056, -0.31857094];
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
...
if (true) then
{
  _this = "Land_Camp_Fire_DZ" createVehicleLocal [11862.964, 12748.467, -0.34177306];
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
...
if (true) then
{
  _this = "Land_Camp_Fire_DZ" createVehicleLocal [11846.282, 12751.074, -0.27414048];
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
...
if (true) then
{
  _this = "Land_Camp_Fire_DZ" createVehicleLocal [11844.693, 12749.784, -0.14887024];
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
...
if (true) then
{
  _this = "Land_Camp_Fire_DZ" createVehicleLocal [11845.191, 12747.735, -0.15923657];
_this setVariable ["", true]; // prevent network SV by loot/zeds spawner
