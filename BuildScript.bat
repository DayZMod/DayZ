...
:menu_0 Full
mkdir %Deploy%
:: mkdir %ModName% - doesn't seem to be used
mkdir %deploy%\@Hive
...
cd %home%
:: copy Binaries\Database.dll %Deploy%\ Not in the folder
...
:: copy SQF\mod.paa %Deploy%\%ModName% - Not in the folder
copy SQF\do_not_use_without_permissions.txt %Deploy%\%ModName%
copy SQF\credits.txt %Deploy%\%ModName%
:: copy BattlEye-Filters\ %Deploy%\cfgdayz\BattlEye\ - Not in the folder
:: copy BattlEye-Filters\ %Deploy%\Battleye-Filters - Not in the folder
